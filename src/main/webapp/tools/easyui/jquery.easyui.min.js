...
var ac = opts.autocomplete || 'off';
if(opts.multiline){
$("<textarea id=\""+_580+"\" class=\"textbox-text\" autocomplete=\"" + ac + "\"></textarea>").prependTo(tb);
}else{
$("<input id=\""+_580+"\" type=\""+opts.type+"\" class=\"textbox-text\" autocomplete=\"" + ac + "\">").prependTo(tb);
}
...
$.fn.textbox.defaults=$.extend({},$.fn.validatebox.defaults,{doSize:true,width:"auto",height:"auto",cls:null,prompt:"",value:"",type:"text",multiline:false,icons:[],iconCls:null,iconAlign:"right",iconWidth:20,buttonText:"",buttonIcon:null,buttonAlign:"right",label:null,labelWidth:"auto",labelPosition:"before",labelAlign:"left",inputEvents:{blur:function(e){
var t=$(e.data.target);
