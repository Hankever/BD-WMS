...
/**
 * 出库单号 下单日期 货品 货品编码 订单数量 单价 金额 批号 包装量 备注 收件人 收件电话 收件地址
 */
public class ImportOrder extends ImportCSV {
	...
	protected String import2db(_Database _db, HttpServletRequest request, 
		...
		String result = impService.importOrder(warehouse_id, owner_id, valuesMaps, progress);
